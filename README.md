...
侧栏显示最近一次发起备份下载的日期。新增收藏达到 10 篇，或阅读状态有变化且两周未备份时，显示轻提示。浏览器无法确认下载文件是否已妥善保存，请确认下载结果。v4 备份也包含检查起点和浏览偏好；导入时合并检查起点并恢复偏好，旧 v1–v4 备份仍可使用。各设备继续独立存储，备份提醒时间以当前设备为准。
