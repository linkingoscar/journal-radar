...
for name in ['index.html','app.js','archives.js','reading.js','library.js','citeproc.js','citations.js','favorites.js','apa.csl','locales-en-US.xml','style.css','enhancements.css','translation.js','catalog.js','sw.js','manifest.webmanifest','icon-192.png','icon-512.png']:
