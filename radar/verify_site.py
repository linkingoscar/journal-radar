...
for name in ['index.html','app.js','archives.js','reading.js','library.js','style.css','enhancements.css','translation.js','catalog.js','sw.js','manifest.webmanifest','icon-192.png','icon-512.png']:
