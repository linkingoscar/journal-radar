...
const SHELL='journal-radar-shell-v17', DATA='journal-radar-data-v1';
const FILES=['./','index.html','style.css','enhancements.css','translation.js','catalog.js','reading.js','archives.js','library.js','citeproc.js','citations.js','favorites.js','apa.csl','locales-en-US.xml','app.js','icon.svg','icon-192.png','icon-512.png','manifest.webmanifest',...Object.values(JOURNAL_CATALOG).map(j=>j.cover).filter(Boolean)];
